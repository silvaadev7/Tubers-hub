--[[ Phantom Client Portugues 🇧🇷 ]]
local Libary = loadstring(game:HttpGet("https://scriptsnessauth.vercel.app/api/scripts/03436fa6-6495-4300-a76e-93171564885b/raw"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "👾 tubers hub  v6 👾 | Brookhaven RP 🏡",
    SubTitle = "by: silvadev",
    LoadText = "Carregando tubers hub",
    Flags = "tuberd_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://106726273569754", BackgroundTransparency = 0 },
...
InfoTab:AddDiscordInvite({
    Name = "tubers comunity",
    Description = "Join server",
    Logo = "rbxassetid://106726273569754",
    Invite = "https://discord.gg/NjBp6WfUk",
}) 
InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Proprietário / Desenvolvedor:", "silvadev" })
InfoTab:AddParagraph({ "Collaborations:", "tubers team" }) 
InfoTab:AddParagraph({ "Obsfucador:", "??" })
InfoTab:AddParagraph({ "Segurança:", "Silvadev" })
InfoTab:AddParagraph({ "Você está usando:", "tubers hub Brookhaven " })
...
TrollTab:AddButton({
    ...
    Name = "SkyBox [ by The DarknesxzDev]",
